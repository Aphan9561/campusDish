...
IRVINE_OFFSET = int(datetime.datetime.utcnow().astimezone(
    pytz.timezone('America/New_York')).utcoffset().total_seconds())
# Constants

LOCATION_INFO = {
    'GibbesCourtBistro': {
        'official': 'GibbesCourtBistro',
        'id': 10434,
    },

    'ThePavilion': {
        'official': 'ThePavilion',
        'id': 73163,
    },

    'GamecockPark': {
        'official': 'GamecockPark',
        'id': 15877,
    },

    'CommunityTable': {
        'official': 'CommunityTable',
        'id': 10459,
    },

    'HoneycombCafe': {
        'official': 'HoneycombCafe',
        'id': 10433,
    },

    'FreshGreenes': {
        'official': 'FreshGreenes',
        'id': 10454,
    }
